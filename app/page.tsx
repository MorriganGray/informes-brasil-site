...
export default function Home() {
  return (
    <body className="bg-brand-light font-lato text-brand-dark">
          ...
          <div className="relative container mx-auto px-4">
              <div className="flex items-center justify-between h-20">
                  ...
                  <a href="#" className="flex items-center space-x-3">
                      <img src="https://i.imgur.com/xhFlDdX.png" alt="Logo Informes Brasil" className="h-16 w-auto object-contain -ml-4"/>
                  </a>

                  {/* Navegação Principal (Desktop) */}
                  <nav className="hidden lg:flex items-center space-x-8">
                      <a href="#" className="font-montserrat font-bold text-sm uppercase tracking-wider transition-colors duration-300 text-brand-dark hover:text-brand-blue">Política</a>
                      <a href="#" className="font-montserrat font-bold text-sm uppercase tracking-wider transition-colors duration-300 text-brand-dark hover:text-brand-blue">Economia</a>
                      <a href="#" className="font-montserrat font-bold text-sm uppercase tracking-wider transition-colors duration-300 text-brand-dark hover:text-brand-blue">Cultura</a>
                      <a href="#" className="font-montserrat font-bold text-sm uppercase tracking-wider transition-colors duration-300 text-brand-dark hover:text-brand-blue">Tecnologia</a>
                  </nav>
                  ...
                  <div className="flex items-center space-x-4">
                      ...
                      <button id="menu-btn" className="lg:hidden focus:outline-none text-brand-dark">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
